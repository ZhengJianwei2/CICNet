...
class CDTrainer():
    ...
    def _forward_pass(self, batch):
        ...
        self.G_pred1, self.G_pred2, self.G_pred_middle1, self.G_pred_middle2 = self.net_G(img_in1, img_in2) 
    ...
    def _backward_G(self):
        ...
        self.G_loss =  self._pxl_loss(self.G_pred1, gt) + self._pxl_loss(self.G_pred2, gt) + 0.5*(self._pxl_loss(self.G_pred_middle1, gt) +self._pxl_loss(self.G_pred_middle2, gt))
